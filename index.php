...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="abel.css">
...
<body>
    <section id="header">
      ...
      <br/>
      <div id="p1">
      <input class="pwdBox" id="pwd1" type="text" value="Password"/>
    </div>
      <br/>
      <div id="p2">
      <input class="pwdBox" id="pwd2" type="text" value="Re-enter password"/>
    </div>
    <br/>
    <div id="upload">
